  ...
  return (
    <div className="landing-frames">
      ...
      <div className="relations-flex container">
        ...
        <motion.div
          className="relationships-flex-image"
          initial={{ opacity: 0, y: 250 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 1.5 }}
      ...
      <div className="git-flex container">
        <div className="git-button">DineshK-1</div>
        <div className="git-button">Mayank Roy</div>
      </div>
    </div>
  );
}
